      ...
      <div className="bg-background border border-border rounded-xl p-4 space-y-3">
        ...
        <div>
          ...
          <input
            ...
            className="w-24 bg-card border border-border rounded-xl px-3 py-2 text-sm text-foreground focus:outline-none focus:border-primary/30 mt-1"
          />
        </div>
      </div>

      <button onClick={save} disabled={saving}
        className="flex items-center gap-1.5 px-5 py-2.5 bg-accent text-primary-foreground rounded-xl text-sm font-semibold hover:bg-primary/80 transition-colors disabled:opacity-30"
      >
